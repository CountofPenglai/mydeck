...
func can_equip_main_hand() -> bool:
	return equip_category == EquipCategory.ONE_HAND or equip_category == EquipCategory.TWO_HAND


func can_equip_off_hand() -> bool:
	return equip_category == EquipCategory.ONE_HAND or equip_category == EquipCategory.OFF_HAND
